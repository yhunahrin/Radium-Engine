...
namespace Ra
{
    namespace Gui
    {
            ...
            , m_selectedAxis(-1)
        {
            ...
            for (uint i = 0; i < 3; ++i)
            {
                Core::TriangleMesh torus =
                    Core::MeshUtils::makeParametricTorus<32>(torusOutRadius,
                                               ...
                                               const Core::Vector2&  nextXY)
        {
            if (m_selectedAxis >= 0)
            {
                ...
                bool                hit1              = Core::RayCast::vsPlane(rayToFirstClick,
                                                   m_worldTo * origin,
                                                   m_worldTo * rotationAxis,
                                                   hits1);
                bool hit2 = Core::RayCast::vsPlane(rayToCurrentClick,
                                                   m_worldTo * origin,
                                                   m_worldTo * rotationAxis,
                                                   hits2);
