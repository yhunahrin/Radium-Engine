...
/// CONSTRUCTOR
    AssimpHandleDataLoader::AssimpHandleDataLoader(const bool VERBOSE_MODE) : Asset::DataLoader<Asset::HandleData>(
        VERBOSE_MODE)
    {}
...
/// LOAD
    void AssimpHandleDataLoader::loadHandleData(const aiScene *scene,
    ...
    void AssimpHandleDataLoader::loadHandleComponentData(const aiScene *scene,
                                                         const aiMesh *mesh,
...
/// NAME
    void AssimpHandleDataLoader::fetchName(const aiMesh &mesh,
                                           Asset::HandleData &data,
