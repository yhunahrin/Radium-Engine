...
namespace Ra {
  namespace Gui {
    ...
    void KeyMappingManager::loadConfigurationInternal()
    {
        ...
        {
            LOG(logWARNING)
                << "No <keymaps> global bounding tag ! Maybe you set a different global tag ? (Not a big deal)";
        }
    ...
    {
        KeyMappingAction
            actionValue = static_cast<KeyMappingAction>( m_metaEnumAction.keyToValue(actionString.c_str()));
