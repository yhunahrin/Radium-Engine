      ...
      void splitEdge(TopologicalMesh &topologicalMesh, TopologicalMesh::EdgeHandle edgeHandle, Scalar fraction)
      {
          ...
          */
          ...
          TopologicalMesh::VertexHandle
              v1 = topologicalMesh.to_vertex_handle(topologicalMesh.halfedge_handle(edgeHandle, 0));
          TopologicalMesh::VertexHandle
              v2 = topologicalMesh.to_vertex_handle(topologicalMesh.halfedge_handle(edgeHandle, 1));

          TopologicalMesh::Point p = TopologicalMesh::Point(
              fraction * topologicalMesh.point(v1) + (1. - fraction) * topologicalMesh.point(v2));
          TopologicalMesh::Normal n = TopologicalMesh::Normal((fraction * topologicalMesh.normal(v1)
              + (1. - fraction) * topologicalMesh.normal(v2)).normalized());
