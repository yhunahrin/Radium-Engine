...
*/
    ...
    public:
        ...
        typedef typename IndexContainer::const_iterator
            ConstIndexIterator;    /// Const iterator to the list of indices of the IndexMap.
        ...
        typedef typename Container::const_iterator
            ConstIterator;         /// Const iterator to the list of objects of the IndexMap.
