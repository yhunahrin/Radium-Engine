...
*/
    ...
    protected:
        ...
        virtual bool importData(std::istream &file,
                                DATA &data) = 0;         // Load data from a given file. Return false if an error occurs, true otherwise.
        virtual bool exportData(std::ostream &file,
                                const DATA &data) = 0;   // Store given data into a given file. Return false if an error occurs, true otherwise.
