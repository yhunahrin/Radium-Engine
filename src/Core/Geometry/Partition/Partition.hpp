...
*/
      VertexSegment extractVertexSegment(const Animation::MeshWeight &weights,
                                         const Index &id,
...
* If is_max is true, only the vertices where id is the most influent one will be returned.
*/
      VertexSegment extractVertexSegment(const Animation::WeightMatrix &weights,
                                         const Index &id,
                                         const bool use_max = true);
...
*/
      ...
      MeshPartition partition(const TriangleMesh &mesh,
