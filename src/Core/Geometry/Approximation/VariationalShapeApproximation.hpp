 ...
 */
      ...
      protected:
          ...
          virtual Energy E(const TriangleIdx &T,
                           const Proxy &P) const = 0;    ///< Computes the energy function for the given triangle and the given Proxy.
 ...
 */
      ...
      protected:
          ...
          // ENERGY
          //////////////////////////////////////////////////////////////////////////////
          inline Scalar E(const TriangleIdx &T,
 ...
 */
      template<uint K_Region>
      class VariationalShapeApproximation<K_Region, MetricType::LLOYD> : public VariationalShapeApproximationBase<
          K_Region>
      {
      public:
          //////////////////////////////////////////////////////////////////////////////
