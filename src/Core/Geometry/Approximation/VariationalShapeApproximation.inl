...
//////////////////////////////////////////////////////////////////////////////
      template<uint K_Region>
      inline const typename VariationalShapeApproximationBase<K_Region>::Region &VariationalShapeApproximationBase<
          K_Region>::region(const uint i) const
      {
...
//////////////////////////////////////////////////////////////////////////////
      template<uint K_Region>
      inline const typename VariationalShapeApproximationBase<K_Region>::Proxy &VariationalShapeApproximationBase<
          K_Region>::proxy(const uint i) const
      {
          return m_proxy.at(i);
      }
...
//////////////////////////////////////////////////////////////////////////////
      ...
      template<uint K_Region>
      inline void VariationalShapeApproximationBase<K_Region>::add_neighbors_to_queue(const TriangleIdx &T,
                                                                                      const uint proxy_id)
      {
...
//////////////////////////////////////////////////////////////////////////////
      template<uint K_Region>
      inline Scalar VariationalShapeApproximation<K_Region, MetricType::LLOYD>::E(const TriangleIdx &T,
                                                                                  const Proxy &P) const
      {
