...
namespace Ra
{
    namespace Engine
    {
        ...
        public:
            ...
            ///     // Retrieve an already created configuration, or create one (see
            ///     ShaderConfiguration docs).
            ...
            static RenderObject* createRenderObject(
                ...
                const ShaderConfiguration& shaderConfig =
                    ShaderConfigurationFactory::getConfiguration("BlinnPhong"),
                Material* material = nullptr);
            static RenderObject* createFancyFromAsset(const std::string&             name,
                                                      Component*                     comp,
            ...
            /// If it goes to zero, then render object notifies the manager that it needs to be
            /// deleted.
            ...
            virtual void render(const RenderParameters& lightParams,
                                ...
                                const ShaderProgram*    altShader = nullptr);
