...
namespace RaTests {
  class DistanceTests : public Test
  {
      void run() override
      {
          ...
          Scalar distLineToSeg = Ra::Core::DistanceQueries::lineToSegSq(lineOrigin,
                                                                        lineDirection,
                                                                        segCenter,
                                                                        segDirection,
                                                                        segExtent).sqrDistance;
          ...
          Scalar distSegToTri =
              Ra::Core::DistanceQueries::segmentToTriSq(segCenter, segDirection, segExtent, v).sqrDistance;
